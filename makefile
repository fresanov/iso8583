...
build:
	go build -mod=vendor -ldflags "-X github.com/fresanov/iso8583.Version=${VERSION}" -o bin/iso8583 github.com/fresanov/iso8583/cmd/iso8583
...
test: update
	go test -cover github.com/fresanov/iso8583/...
