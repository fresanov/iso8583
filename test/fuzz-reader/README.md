...
```
$ kubectl exec -n apps iso8583fuzz-6bbdc574f5-pl2zm -- ls -la /go/src/github.com/fresanov/iso8583/test/fuzz-reader/crashers/
total 28
...
$ kubectl cp 'apps/iso8583fuzz-6bbdc574f5-pl2zm:/go/src/github.com/fresanov/iso8583/test/fuzz-reader/crashers/<file>' ./
```
